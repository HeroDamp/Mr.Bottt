/*
* Mr.Bottt - Busqueda de datos del servidor.
*
* (Basado en el archivo gerserver.js
* de ecuacion)
*/
		...
		var req = http.request(requestOptions, function (res) {
			...
			res.on('end', function () {
				...
				if (index !== -1) {
					...
					console.log('Proceda a copiar los datos obtenidos en el archivo ' + ('config.js').yellow + '\n');
					rl.close();
					return process.exit();
				} else {
...
console.log((
	"\n-------------------------------------------\n" +
	"   Iniciando sistema de busqueda de Datos      \n" +
	"-------------------------------------------\n"
).yellow);
